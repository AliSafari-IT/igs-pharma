...
public class PharmacyDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>().HasData(
            new Category { Id = 1, Name = "Pain Relief", Description = "Pain management medications" },
            new Category { Id = 2, Name = "Antibiotics", Description = "Antibiotic medications" },
            new Category { Id = 3, Name = "Vitamins", Description = "Vitamin supplements" },
            new Category { Id = 4, Name = "Cold & Flu", Description = "Cold and flu medications" },
            new Category { Id = 5, Name = "Diabetes", Description = "Diabetes management products" }
        );
