...
namespace IGS.Infrastructure.Migrations
{
    ...
    [Migration("20250630061417_MigrationName")]
            ...
            modelBuilder.Entity("IGS.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5178),
                            Description = "Pain management medications",
                            IsActive = true,
                            Name = "Pain Relief",
                            UpdatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5181)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5213),
                            Description = "Antibiotic medications",
                            IsActive = true,
                            Name = "Antibiotics",
                            UpdatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5214)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5216),
                            Description = "Vitamin supplements",
                            IsActive = true,
                            Name = "Vitamins",
                            UpdatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5216)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5217),
                            Description = "Cold and flu medications",
                            IsActive = true,
                            Name = "Cold & Flu",
                            UpdatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5217)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5219),
                            Description = "Diabetes management products",
                            IsActive = true,
                            Name = "Diabetes",
                            UpdatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 653, DateTimeKind.Utc).AddTicks(5219)
                        });
                });
            ...
            modelBuilder.Entity("IGS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CardId = "",
                            CreatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 842, DateTimeKind.Utc).AddTicks(8999),
                            Department = "",
                            Email = "admin@igs-pharma.com",
                            EmployeeId = "",
                            FirstName = "Admin",
                            IsActive = true,
                            LastLoginAt = new DateTime(2025, 6, 30, 6, 14, 14, 842, DateTimeKind.Utc).AddTicks(9005),
                            LastName = "User",
                            LicenseNumber = "ADMIN001",
                            PasswordHash = "$2a$11$9oMCIR.C/4Cg1iRfPGjIR.vuVdnYJPM0/nPXWVvhVCRczcRlKZxS2",
                            Permissions = "[]",
                            Phone = "",
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 6, 30, 6, 14, 14, 842, DateTimeKind.Utc).AddTicks(9004),
                            Username = ""
                        });
                });
