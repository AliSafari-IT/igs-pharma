    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsuranceNumber = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    InsuranceProvider = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Allergies = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MedicalConditions = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DoctorLicense = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DoctorPhone = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    TotalRefills = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Dosage = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Instructions = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DaysSupply = table.Column<int>(type: "int", nullable: false),
                    IsGenericAllowed = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4338), "Pain management medications", true, "Pain Relief", new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4342) },
                    { 2, new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4387), "Antibiotic medications", true, "Antibiotics", new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4388) },
                    { 3, new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4389), "Vitamin supplements", true, "Vitamins", new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4389) },
                    { 4, new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4391), "Cold and flu medications", true, "Cold & Flu", new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4391) },
                    { 5, new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4393), "Diabetes management products", true, "Diabetes", new DateTime(2025, 6, 29, 20, 1, 55, 116, DateTimeKind.Utc).AddTicks(4394) }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "IsActive", "LastLoginAt", "LastName", "LicenseNumber", "PasswordHash", "Phone", "Role", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2025, 6, 29, 20, 1, 55, 588, DateTimeKind.Utc).AddTicks(4831), "admin@igs-pharma.com", "Admin", true, new DateTime(2025, 6, 29, 20, 1, 55, 588, DateTimeKind.Utc).AddTicks(4840), "User", "ADMIN001", "$2a$11$ciWbz.EksHnzGPkW/gzGtOkJVXSutZbKL3igCpcZOqHDbXVTu8eZO", "", 0, new DateTime(2025, 6, 29, 20, 1, 55, 588, DateTimeKind.Utc).AddTicks(4838) });
