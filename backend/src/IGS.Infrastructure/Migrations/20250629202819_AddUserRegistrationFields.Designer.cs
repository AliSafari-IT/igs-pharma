...
namespace IGS.Infrastructure.Migrations
{
    ...
    [Migration("20250629202819_AddUserRegistrationFields")]
            ...
            modelBuilder.Entity("IGS.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(389),
                            Description = "Pain management medications",
                            IsActive = true,
                            Name = "Pain Relief",
                            UpdatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(393)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(397),
                            Description = "Antibiotic medications",
                            IsActive = true,
                            Name = "Antibiotics",
                            UpdatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(397)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(399),
                            Description = "Vitamin supplements",
                            IsActive = true,
                            Name = "Vitamins",
                            UpdatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(399)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(400),
                            Description = "Cold and flu medications",
                            IsActive = true,
                            Name = "Cold & Flu",
                            UpdatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(401)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(402),
                            Description = "Diabetes management products",
                            IsActive = true,
                            Name = "Diabetes",
                            UpdatedAt = new DateTime(2025, 6, 29, 20, 28, 18, 952, DateTimeKind.Utc).AddTicks(402)
                        });
                });
            ...
            modelBuilder.Entity("IGS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CardId = "",
                            CreatedAt = new DateTime(2025, 6, 29, 20, 28, 19, 163, DateTimeKind.Utc).AddTicks(4371),
                            Department = "",
                            Email = "admin@igs-pharma.com",
                            EmployeeId = "",
                            FirstName = "Admin",
                            IsActive = true,
                            LastLoginAt = new DateTime(2025, 6, 29, 20, 28, 19, 163, DateTimeKind.Utc).AddTicks(4377),
                            LastName = "User",
                            LicenseNumber = "ADMIN001",
                            PasswordHash = "$2a$11$Vt.MUX.MZ7W.9BLKJBpZXOiygJIBpGTEnpCmoUPErBqt9rrgAdnyq",
                            Permissions = "[]",
                            Phone = "",
                            Role = 0,
                            UpdatedAt = new DateTime(2025, 6, 29, 20, 28, 19, 163, DateTimeKind.Utc).AddTicks(4376),
                            Username = ""
                        });
                });
